...
const { aroon: AroonIndicator } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;

const { extend, merge: AroonOscillatorIndicator_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
/* harmony default export */ const aroon_oscillator_src = ((external_highcharts_src_js_default_default()));

export { aroon_oscillator_src as default };
