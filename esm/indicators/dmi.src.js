...
const { correctFloat, extend, isArray, merge: DMIIndicator_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
/* harmony default export */ const dmi_src = ((external_highcharts_src_js_default_default()));

export { dmi_src as default };
