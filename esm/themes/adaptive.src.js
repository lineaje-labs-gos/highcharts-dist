...
;// ./code/es-modules/masters/themes/adaptive.src.js




(external_highcharts_src_js_default_default()).theme = Adaptive.options;
Adaptive.apply();
/* harmony default export */ const adaptive_src = ((external_highcharts_src_js_default_default()));

export { adaptive_src as default };
