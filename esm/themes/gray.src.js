...
(external_highcharts_src_js_default_default()).theme = Gray.options;
Gray.apply();
/* harmony default export */ const gray_src = ((external_highcharts_src_js_default_default()));

export { gray_src as default };
