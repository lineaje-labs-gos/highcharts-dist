...
const { correctFloat, isNumber, isObject } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
...
const { composed, noop } = (external_highcharts_src_js_default_default());
...
const { addEvent, clamp, crisp, defined, extend: XRangeSeries_extend, find, isNumber: XRangeSeries_isNumber, isObject: XRangeSeries_isObject, merge, pick, pushUnique, relativeLength } = (external_highcharts_src_js_default_default());
...
XRangeSeries_extend(XRangeSeries.prototype, {
    ...
    type: 'xrange',
    animate: (external_highcharts_src_js_default_SeriesRegistry_default()).series.prototype.animate,
    autoIncrement: noop,
    buildKDTree: noop
});
external_highcharts_src_js_default_SeriesRegistry_default().registerSeriesType('xrange', XRangeSeries);
/* *
 *
 * Default Export
 *
...
/* harmony default export */ const xrange_src = ((external_highcharts_src_js_default_default()));

export { xrange_src as default };
