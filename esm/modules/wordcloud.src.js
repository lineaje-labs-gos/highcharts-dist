...
const { extend: WordcloudUtils_extend, find, isNumber, isObject, merge } = (external_highcharts_src_js_default_default());
/* *
 *
 * Functions
 *
...
const { extend: WordcloudSeries_extend, isArray, isNumber: WordcloudSeries_isNumber, isObject: WordcloudSeries_isObject, merge: WordcloudSeries_merge } = (external_highcharts_src_js_default_default());
...
class WordcloudSeries extends ColumnSeries {
    ...
    pointAttribs(point, state) {
        const attribs = external_highcharts_src_js_default_default().seriesTypes.column.prototype
...
external_highcharts_src_js_default_SeriesRegistry_default().registerSeriesType('wordcloud', WordcloudSeries);
/* *
 *
 *  Default Export
 *
...
/* harmony default export */ const wordcloud_src = ((external_highcharts_src_js_default_default()));

export { wordcloud_src as default };
