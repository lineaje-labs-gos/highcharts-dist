...
const { error, extend, merge: Funnel3DComposition_merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
const { extend: Funnel3DPoint_extend } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
const { extend: Funnel3DSeries_extend, merge: Funnel3DSeries_merge, pick: Funnel3DSeries_pick, relativeLength } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
