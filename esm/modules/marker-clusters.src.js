...
const { addEvent, defined, error, isArray, isFunction, isObject, isNumber, merge, objectEach: MarkerClusterScatter_objectEach, relativeLength, syncTimeout } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
...
const { addEvent: MarkerClusters_addEvent, defined: MarkerClusters_defined, error: MarkerClusters_error, isFunction: MarkerClusters_isFunction, merge: MarkerClusters_merge, pushUnique, syncTimeout: MarkerClusters_syncTimeout } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
