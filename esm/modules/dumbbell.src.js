...
const { defined, isNumber } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
const { extend, pick } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
const { arearange: AreaRangeSeries, column: ColumnSeries, columnrange: ColumnRangeSeries } = (external_highcharts_src_js_default_SeriesRegistry_default()).seriesTypes;


const { extend: DumbbellSeries_extend, merge, pick: DumbbellSeries_pick } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
external_highcharts_src_js_default_SeriesRegistry_default().registerSeriesType('dumbbell', DumbbellSeries);
/* *
 *
 *  Default Export
 *
...
/* harmony default export */ const dumbbell_src = ((external_highcharts_src_js_default_default()));

export { dumbbell_src as default };
