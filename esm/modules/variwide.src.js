...
const { addEvent, pushUnique, wrap } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
class VariwideSeries extends ColumnSeries {
    ...
    processData(force) {
        this.totalZ = 0;
        this.relZ = [];
        external_highcharts_src_js_default_SeriesRegistry_default().seriesTypes.column.prototype.processData.call(this, force);
...
external_highcharts_src_js_default_SeriesRegistry_default().registerSeriesType('variwide', VariwideSeries);
/* *
 *
 *  Default Export
 *
...
/* harmony default export */ const variwide_src = ((external_highcharts_src_js_default_default()));

export { variwide_src as default };
