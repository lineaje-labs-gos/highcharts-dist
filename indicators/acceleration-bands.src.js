...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("highcharts/indicators/acceleration-bands", ["highcharts/highcharts"], function (amd1) {return factory(amd1,amd1["SeriesRegistry"]);});
	else if(typeof exports === 'object')
		exports["highcharts/indicators/acceleration-bands"] = factory(root["_Highcharts"], root["_Highcharts"]["SeriesRegistry"]);
	else
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ acceleration_bands_src)
});
...
const { correctFloat, extend, merge: ABandsIndicator_merge } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Functions
 *
...
;// ./code/es-modules/masters/indicators/acceleration-bands.src.js




/* harmony default export */ const acceleration_bands_src = ((highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()));
